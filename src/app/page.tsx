...
export default function LandingPage() {
  return (
    <main className="min-h-screen overflow-x-hidden bg-black text-neutral-100 selection:bg-[#c7b48f] selection:text-black">
      ...
      <section className="relative isolate overflow-hidden border-b border-neutral-900">
        <div
          aria-hidden="true"
          className="pointer-events-none absolute inset-x-[-18%] bottom-[-8%] -z-10 h-[58%] bg-[radial-gradient(ellipse_60%_72%_at_50%_78%,rgba(174,255,72,0.56)_0%,rgba(128,210,55,0.24)_38%,rgba(52,95,30,0.07)_60%,transparent_78%)] blur-2xl sm:inset-x-[-8%] sm:h-[62%]"
        />
        ...
        <div className="mx-auto grid min-h-[calc(100svh-5rem)] max-w-7xl gap-16 px-5 py-16 sm:px-8 sm:py-20 lg:grid-cols-[minmax(0,1.35fr)_minmax(17rem,0.65fr)] lg:items-center lg:gap-20 lg:px-10 lg:py-24">
          <div className="max-w-4xl">
            <p className="mb-7 font-mono text-[0.69rem] uppercase tracking-[0.24em] text-[#bca987] sm:mb-9">Sistema para barbearias</p>
          ...
          <aside className="w-full max-w-md border-t border-neutral-800 pt-7 lg:justify-self-end lg:border-l lg:border-t-0 lg:pl-8 lg:pt-0" aria-label="Resumo do produto">
            <p className="font-mono text-[0.69rem] uppercase tracking-[0.22em] text-[#bca987]">Do link ao atendimento</p>
      ...
      <section id="como-funciona" className="relative isolate overflow-hidden bg-neutral-950">
        <div
          aria-hidden="true"
          className="pointer-events-none absolute inset-x-[-18%] top-[-8%] z-0 h-[38%] bg-[radial-gradient(ellipse_60%_72%_at_50%_22%,rgba(174,255,72,0.42)_0%,rgba(128,210,55,0.18)_38%,rgba(52,95,30,0.05)_60%,transparent_78%)] blur-2xl sm:inset-x-[-8%]"
        />
        <div className="relative z-10 mx-auto max-w-7xl px-5 py-20 sm:px-8 md:py-28 lg:px-10">
          <div className="grid gap-12 lg:grid-cols-[0.72fr_1.28fr] lg:gap-20">
            <header>
              <p className="font-mono text-[0.69rem] uppercase tracking-[0.22em] text-[#bca987]">Como funciona</p>
            ...
            <ol className="border-t border-neutral-800">
              {operations.map((item) => (
                <li key={item.number} className="grid gap-3 border-b border-neutral-800 py-7 sm:grid-cols-[3.5rem_11rem_1fr] sm:items-start sm:gap-5">
                  <span className="font-mono text-xs text-[#bca987]">{item.number}</span>
      ...
      <section id="recursos" className="relative isolate mx-auto max-w-7xl overflow-hidden px-5 py-20 sm:px-8 md:py-28 lg:px-10">
        <div
          aria-hidden="true"
          className="pointer-events-none absolute inset-x-[-35%] bottom-[-16%] -z-10 h-[54%] bg-[radial-gradient(ellipse_48%_72%_at_72%_84%,rgba(174,255,72,0.28)_0%,rgba(128,210,55,0.11)_42%,transparent_76%)] blur-3xl"
        />
        <div className="grid gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:gap-24">
          <div>
            <p className="font-mono text-[0.69rem] uppercase tracking-[0.22em] text-[#bca987]">O que está incluído</p>
          ...
          <ul className="border-t border-neutral-800">
            {included.map((item) => (
              <li key={item} className="flex gap-4 border-b border-neutral-800 py-5 leading-7 text-neutral-300">
                <Check className="mt-1 size-4 shrink-0 text-[#bca987]" aria-hidden="true" />
                <span>{item}</span>
              </li>
            ))}
          </ul>
      ...
      <section id="plano" className="relative isolate overflow-hidden border-t border-neutral-900">
        <div
          aria-hidden="true"
          className="pointer-events-none absolute inset-x-[-35%] top-[-16%] -z-10 h-[50%] bg-[radial-gradient(ellipse_48%_72%_at_72%_16%,rgba(174,255,72,0.24)_0%,rgba(128,210,55,0.09)_42%,transparent_76%)] blur-3xl"
        />
        <div className="mx-auto grid max-w-7xl gap-12 px-5 py-20 sm:px-8 md:py-28 lg:grid-cols-[0.85fr_1.15fr] lg:items-start lg:gap-24 lg:px-10">
          <header>
            <p className="font-mono text-[0.69rem] uppercase tracking-[0.22em] text-[#bca987]">Assinatura</p>
